...
+(void)connectQQWithAppId:(NSString *)appId withKey: (NSString *)key{
    [self set:schema Keys:@{@"appid":appId,@"callback_name":[NSString stringWithFormat:@"QQ%08llx",[appId longLongValue]]}];
    [[NSUserDefaults standardUserDefaults] setObject:appId forKey:kOSPlatformQQIdKey];
    [[NSUserDefaults standardUserDefaults] setObject:key forKey:kOSPlatformQQSecretKey];
