...
+(void)connectWeiboWithAppKey:(NSString *)appKey withKey:(NSString *)key redirectURI:(NSString *)redirectURI{
    [self set:schema Keys:@{@"appKey":appKey}];
    
    [[NSUserDefaults standardUserDefaults] setObject:appKey forKey:kOSPlatformWeiboIdKey];
    [[NSUserDefaults standardUserDefaults] setObject:key forKey:kOSPlatformWeiboSecretKey];
    [[NSUserDefaults standardUserDefaults] setObject:redirectURI forKey:kOSPlatformWeiboRedirectURIKey];
