...
+(void)connectWeixinWithAppId:(NSString *)appId withKey:(NSString *)key{
    [self set:schema Keys:@{@"appid":appId}];
    
    [[NSUserDefaults standardUserDefaults] setObject:appId forKey:kOSPlatformWeixinIdKey];
    [[NSUserDefaults standardUserDefaults] setObject:key forKey:kOSPlatformWeixinSecretKey];
