...
// 平台类型
typedef enum : NSUInteger {
    OSThirdPlatformTypeQQ = 1,
    OSThirdPlatformTypeWeixin,
    OSThirdPlatformTypeWeibo
} OSThirdPlatformType;
// 定义分享类型
typedef enum : NSUInteger {
    OSShareTypeWXSceneSession = 1,  // 分享到微信会话
    OSShareTypeWXSceneTimeline,     // 分享到微信朋友圈
    OSShareTypeQQ,                  // 分享到QQ好友
    OSShareTypeQQZone,              // 分享到QQ空间
    OSShareTypeWeibo,               // 分享到新浪微博
} OSShareType;


// 定义相关常量定义Key
static NSString *const kOSPlatformWeixinIdKey         = @"kOSPlatformWeixinIdKey";
static NSString *const kOSPlatformWeiboIdKey          = @"kOSPlatformWeiboIdKey";
static NSString *const kOSPlatformQQIdKey             = @"kOSPlatformQQIdKey";
static NSString *const kOSPlatformWeixinSecretKey     = @"kOSPlatformWeixinSecretKey";
static NSString *const kOSPlatformWeiboSecretKey      = @"kOSPlatformWeiboSecretKey";
static NSString *const kOSPlatformWeiboRedirectURIKey = @"kOSPlatformWeiboRedirectURIKey";
static NSString *const kOSPlatformQQSecretKey         = @"kOSPlatformQQSecretKey";
/**
 *  OSMessage保存分享消息数据。
 */
